...
class Configurator():
    ...
    def run(self):
        ...
        while True:
            ...
            menu_table.add_row("1.", "Display selfbots")
            menu_table.add_row("2.", "Register new selfbot")
            menu_table.add_row("3.", "Remove selfbot")
            menu_table.add_row("4.", "Display servers")
            menu_table.add_row("5.", "Register new server")
            menu_table.add_row("6.", "Remove server")
            menu_table.add_row("7.", "Reorder servers")
            ...
            match choice:
                ...
                case "5":
                    if self.data_manager.selfbots:
                        ...
                        console.print("No selfbots. Please register a selfbot first.")
                    time.sleep(2)
                case "6":
                    self.data_manager.display_servers()
    ...
    def _display_reordering_servers(self, server_list: list[Server]):
        console.print("\n")
        if not server_list:
